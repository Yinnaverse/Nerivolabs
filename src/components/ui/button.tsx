  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap text-sm font-medium ring-offset-background transition-all duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Custom variants for Nerivo Labs
        primary: "bg-primary text-primary-foreground hover:bg-primary/90 rounded-full",
        secondary_outline: "border border-primary/20 bg-transparent text-foreground hover:border-primary/40 hover:bg-accent/50 rounded-full",
        minimal: "bg-transparent text-foreground hover:text-foreground/70 underline underline-offset-4",
      },
      size: {
